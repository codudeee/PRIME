(function(){
  ...
  function normalizeTier(v){
    ...
    if(/짐승|beast/.test(l)) return 'beast';
    return s;
  }
  function tierLabel(t){
    t=normalizeTier(t);
    if(t==='tier0') return '0티어'; if(t==='tier1') return '1티어'; if(t==='tier2') return '2티어'; if(t==='tier3') return '3티어'; if(t==='tier4') return '4티어'; if(t==='beast') return '짐승';
    return clean(t)||'중';
  }
