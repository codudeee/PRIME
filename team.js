(() => {
  ...
  function installTeamPerformanceStyle() {
    ...
    style.textContent = `
      ...
      /* PKL view-only reroll list: compact readable participant layout */
      #rerollListModal.pkl-reroll-view-only .pkl-reroll-list-modal{
        width:min(920px,calc(100vw - 88px)) !important;
        min-width:min(720px,calc(100vw - 56px)) !important;
        height:min(700px,calc(100vh - 96px)) !important;
      }
      #rerollListModal.pkl-reroll-view-only .pkl-reroll-list-body{
        height:calc(100% - 66px) !important;
      }
      #rerollListModal.pkl-reroll-view-only .pkl-reroll-list-box{
        padding:12px 14px 14px !important;
        border-radius:18px !important;
      }
      #rerollListModal.pkl-reroll-view-only .pkl-reroll-list-head{
        display:grid !important;
        grid-template-columns:minmax(0,1fr) 78px 96px !important;
        gap:12px !important;
        padding:0 12px 8px !important;
        align-items:center !important;
      }
      #rerollListModal.pkl-reroll-view-only .pkl-reroll-list-head span{
        font-size:11px !important;
        color:#cfc4e8 !important;
      }
      #rerollListModal.pkl-reroll-view-only .pkl-reroll-list-entries{
      ...
      #rerollListModal.pkl-reroll-view-only .pkl-reroll-entry{
        ...
        border:1px solid rgba(211,176,73,.74) !important;
        background:linear-gradient(90deg,rgba(25,22,34,.92),rgba(14,12,24,.86)) !important;
        box-shadow:0 0 0 1px rgba(255,215,95,.05), inset 0 0 14px rgba(255,203,66,.035) !important;
      }
      #rerollListModal.pkl-reroll-view-only .pkl-reroll-entry + .pkl-reroll-entry{
        margin-top:8px !important;
      }
      #rerollListModal.pkl-reroll-view-only .pkl-reroll-user{
      ...
      #rerollListModal.pkl-reroll-view-only .pkl-reroll-user-main{
        display:flex !important;
        align-items:center !important;
        gap:8px !important;
        min-width:0 !important;
      ...
      #rerollListModal.pkl-reroll-view-only .pkl-reroll-position{
        margin:3px 0 0 !important;
        padding-left:2px !important;
        font-size:10px !important;
        color:#aa9fc4 !important;
        opacity:.9 !important;
        overflow:hidden !important;
        text-overflow:ellipsis !important;
        white-space:nowrap !important;
      }
      #rerollListModal.pkl-reroll-view-only .pkl-reroll-total-badge{
      ...
      #rerollListModal.pkl-reroll-view-only .pkl-reroll-user-main .pkl-reroll-total-badge{
      ...
      #rerollListModal.pkl-reroll-view-only .pkl-reroll-remove{
        display:none !important;
      }
      @media (max-width:780px){
        ...
        #rerollListModal.pkl-reroll-view-only .pkl-reroll-list-head,
        #rerollListModal.pkl-reroll-view-only .pkl-reroll-entry{
          grid-template-columns:minmax(0,1fr) 58px 82px !important;
          gap:8px !important;
        }
      }
      ...
      /* PKL admin reroll list: stable aligned columns, no position text */
      #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-list-modal{
        width:min(1320px,calc(100vw - 56px)) !important;
        min-width:min(980px,calc(100vw - 40px)) !important;
      }
      #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-layout{
        grid-template-columns:minmax(760px,1fr) minmax(260px,300px) !important;
        gap:18px !important;
      }
      #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-list-head{
        display:grid !important;
        grid-template-columns:minmax(190px,220px) minmax(420px,1fr) 112px 34px !important;
        gap:10px !important;
        align-items:center !important;
        padding:0 12px 8px !important;
      }
      #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-list-head span:nth-child(1){grid-column:1 !important;text-align:left !important;}
      #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-list-head span:nth-child(2){grid-column:2 !important;text-align:center !important;}
      #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-list-head span:nth-child(3){grid-column:3 !important;text-align:center !important;}
      #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-entry{
        grid-template-columns:minmax(190px,220px) minmax(420px,1fr) 112px 34px !important;
        gap:10px !important;
        align-items:center !important;
      ...
      #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-user{
        min-width:0 !important;
        overflow:hidden !important;
      }
      #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-user-main{
        display:grid !important;
      ...
      #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-tier-badge{
        order:0 !important;
        max-width:70px !important;
        transform:scale(.84) !important;
        transform-origin:left center !important;
      }
      #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-user-main strong{
        order:0 !important;
        max-width:none !important;
        min-width:0 !important;
        overflow:hidden !important;
      ...
      #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-total-badge{
        order:0 !important;
      ...
      #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-position{
        display:none !important;
      }
      #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-type-grid{
        display:grid !important;
      ...
      #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-type-control{
        grid-template-rows:13px 23px !important;
        padding:5px 6px !important;
      }
      #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-mini-counter{
        grid-template-columns:21px minmax(24px,1fr) 21px !important;
        gap:4px !important;
      }
      #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-mini-counter button{
        width:21px !important;
        height:21px !important;
        min-width:21px !important;
      }
      #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-mini-counter input{
        height:21px !important;
        font-size:11px !important;
      }
      #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-paid-check{
        width:112px !important;
        height:32px !important;
        justify-self:center !important;
        padding:0 8px !important;
      }
      #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-remove{
      ...
      @media (max-width:1180px){
        #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-layout{grid-template-columns:1fr !important;}
        #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-calculator-panel{display:none !important;}
        #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-list-head,
        #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-entry{
          grid-template-columns:minmax(180px,210px) minmax(410px,1fr) 112px 34px !important;
        }
      }
  ...
  function hydrateTeamPlayerBadgesFromSupabaseOnly() {
    ...
    state.players.forEach(player => {
      ...
      if (isValidTierId(tierKey) && player.tier !== getWaitingTierId(tierKey)) {
        player.tier = getWaitingTierId(tierKey);
        changed = true;
      }
    });
    return changed;
...
const teamIndex = Number(slot.dataset.teamIndex);
  ...
  function movePlayerToOriginalTier(playerId) {
    ...
    if (!player) return;
    insertPlayerIntoWaitingTier(playerId, getWaitingTierId(player.tier));
  }
  ...
  function syncJoinWaitListIntoTeamBoard(forceLoad) {
    ...
    joinList.forEach(item => {
      ...
      const tier = isValidTierId(resolvedTier) ? getWaitingTierId(resolvedTier) : 'tier0';
      ...
      if (player) {
        ...
        player.tier = isValidTierId(tier) ? getWaitingTierId(tier) : player.tier;
      ...
      const nextPlayer = {
        id,
        name: displayName,
        tier: isValidTierId(tier) ? getWaitingTierId(tier) : 'tier0',
  ...
  function resolvePlayerPklTier(player, accountUser) {
    ...
    return isValidTierId(tierKey) ? getWaitingTierId(tierKey) : '';
  }
  ...
  function syncWaitingPoolsWithPlayerTiers() {
    ...
    Object.entries(state.waiting || {}).forEach(([currentTierId, ids]) => {
      if (!Array.isArray(ids)) return;
      const safeTierId = isValidTierId(currentTierId) ? getWaitingTierId(currentTierId) : 'tier0';
      ids.forEach(playerId => {
        ...
        const player = state.players.find(item => item.id === playerId);
        if (!player) return;
        const resolvedTierId = isValidTierId(player.tier) ? getWaitingTierId(player.tier) : safeTierId;
  ...
  function insertPlayerIntoWaitingTier(playerId, tierId) {
    const safeTierId = isValidTierId(tierId) ? getWaitingTierId(tierId) : 'tier0';
  ...
  function getTierNumericIndex(tierId) {
    const canonicalTierId = getWaitingTierId(tierId);
  ...
  function renderPlayerTierBadge(player, accountUser) {
    ...
    const safeTier = isValidTierId(tierValue) ? getWaitingTierId(tierValue) : 'tier0';
  ...
  function resolveSpecificTierScoreRoleValue(source) {
    ...
    if (typeof source === 'object') {
      values.push(
        ...
        source.pklTier, source.tierLabel, source.tierName, source.memberTierName, source.badgeText, source.badge, source.raw
      );
    } else {
      values.push(source);
    }
  ...
  function normalizeTierKey(value) {
    ...
    const compact = text.normalize('NFKC').replace(/\s+/g, '').toLowerCase();
    const normalizedCompact = compact.replace(/[_-]/g, '');

    const specificMap = {
      '짐승':'tier5_low','짐승상':'tier5_high','짐승중':'tier5_mid','짐승하':'tier5_low',
      '5티어상':'tier5_high','5티어중':'tier5_mid','5티어하':'tier5_low','5상':'tier5_high','5중':'tier5_mid','5하':'tier5_low',
      tier5high:'tier5_high',tier5mid:'tier5_mid',tier5middle:'tier5_mid',tier5low:'tier5_low',
      beasthigh:'tier5_high',beastmid:'tier5_mid',beastmiddle:'tier5_mid',beastlow:'tier5_low',beast:'tier5_low'
    };
    if (specificMap[compact] || specificMap[normalizedCompact]) return specificMap[compact] || specificMap[normalizedCompact];

    const specific = normalizedCompact.match(/^tier([0-5])(high|mid|middle|low|상|중|하)$/) || compact.match(/^([0-5])(?:티어)?(상|중|하|high|mid|middle|low)$/);
    if (specific) {
      const pos = { high:'high', mid:'mid', middle:'mid', low:'low', '상':'high', '중':'mid', '하':'low' }[specific[2]] || 'mid';
      return `tier${specific[1]}_${pos}`;
    }
    ...
    if (compact === '5티어' || compact === '5tier' || compact === 'tier5' || compact === 'animal') return 'tier5';

    const koreanTier = compact.match(/^([0-4])티어$/);
    if (koreanTier) return `tier${koreanTier[1]}`;

    const idMatch = normalizedCompact.match(/^tier([0-4])$/);
...
function saveMatchTimeSettings() {
  ...
  function ensureRerollListStyles() {
    ...
    style.textContent = `
      ...
      @media (max-width:760px){
        #rerollListModal.pkl-reroll-view-only .pkl-reroll-entry{grid-template-columns:1fr 82px !important;}
        #rerollListModal.pkl-reroll-view-only .pkl-reroll-paid-view{justify-self:start !important;}
      }
  ...
  function ensureRerollListAdminFinalAlignStyle() {
    if (document.getElementById('pkl-reroll-admin-final-align-style')) return;
    const style = document.createElement('style');
    style.id = 'pkl-reroll-admin-final-align-style';
    style.textContent = `
      /* FINAL: 관리자 리롤 리스트 칸 정렬 전용. 기존 기능/유저용 모달은 건드리지 않음 */
      #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-list-modal{
        width:min(1360px,calc(100vw - 48px)) !important;
        min-width:min(1040px,calc(100vw - 40px)) !important;
      ...
      #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-list-panel,
      #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-list-box{
        min-width:0 !important;
        overflow:hidden !important;
      }
      #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-list-entries{
        overflow-y:auto !important;
        overflow-x:hidden !important;
      ...
      #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-entry{
        display:grid !important;
        grid-template-columns:210px minmax(430px,1fr) 118px 36px !important;
      ...
      #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-list-head span{
        align-self:center !important;
      ...
      #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-type-label{
        display:block !important;
      ...
      #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-mini-counter{
        display:grid !important;
        grid-template-columns:20px minmax(24px,1fr) 20px !important;
        gap:4px !important;
        align-items:center !important;
      ...
      #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-paid-check input{
        margin:0 !important;
        flex:0 0 auto !important;
      }
      #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-paid-check span{
        line-height:1 !important;
        white-space:nowrap !important;
      }
      #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-remove{
      ...
      @media (max-width:1180px){
        ...
        #rerollListModal:not(.pkl-reroll-view-only) .pkl-reroll-calculator-panel{
          display:none !important;
        }
      }
    `;
  ...
  function renderRerollListModal() {
    ...
    ensureRerollListAdminFinalAlignStyle();
        ...
        <div class="pkl-reroll-entry ${request.paid ? 'is-paid' : ''} ${canManageList ? '' : 'is-view-only'}" data-reroll-key="${escapeHtml(item.key)}">
          <div class="pkl-reroll-user">
            <div class="pkl-reroll-user-main">
              ...
              ${canManageList ? `<span class="pkl-reroll-total-badge">${escapeHtml(totalScore)}</span>` : ''}
            </div>
          ...
          ${canManageList ? `
            <div class="pkl-reroll-type-grid">
              ${renderRerollTypeControls(item.key, request, true)}
            </div>
          ` : ''}
          ${canManageList ? `
    ...
    try {
      ...
      if (saved.waiting && typeof saved.waiting === 'object') {
        Object.entries(saved.waiting).forEach(([tierId, ids]) => {
          if (!Array.isArray(ids)) return;
          const safeTierId = validTierIds.has(getWaitingTierId(tierId)) ? getWaitingTierId(tierId) : 'tier0';
          ids.forEach(playerId => {
      ...
      players.forEach(player => {
        ...
        waiting[getWaitingTierId(player.tier) || 'tier0'].push(player.id);
      });
