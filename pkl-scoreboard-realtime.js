(function(){
  ...
  function tierRole(text){var raw=clean(text), c=raw.replace(/[\s_-]+/g,'').toLowerCase();var map={tier0high:'tier0_high',tier0mid:'tier0_mid',tier0low:'tier0_low',tier1high:'tier1_high',tier1mid:'tier1_mid',tier1low:'tier1_low',tier2high:'tier2_high',tier2mid:'tier2_mid',tier2low:'tier2_low',tier3high:'tier3_high',tier3mid:'tier3_mid',tier3low:'tier3_low',tier4high:'tier4_high',tier4mid:'tier4_mid',tier4low:'tier4_low',beast:'beast_low',beasthigh:'beast_high',beastlow:'beast_low','0티어상':'tier0_high','0상':'tier0_high','0티어중':'tier0_mid','0중':'tier0_mid','0티어하':'tier0_low','0하':'tier0_low','1티어상':'tier1_high','1상':'tier1_high','1티어중':'tier1_mid','1중':'tier1_mid','1티어하':'tier1_low','1하':'tier1_low','2티어상':'tier2_high','2상':'tier2_high','2티어중':'tier2_mid','2중':'tier2_mid','2티어하':'tier2_low','2하':'tier2_low','3티어상':'tier3_high','3상':'tier3_high','3티어중':'tier3_mid','3중':'tier3_mid','3티어하':'tier3_low','3하':'tier3_low','4티어상':'tier4_high','4상':'tier4_high','4티어중':'tier4_mid','4중':'tier4_mid','4티어하':'tier4_low','4하':'tier4_low','5티어상':'tier5_high','5상':'tier5_high','5티어하':'tier5_low','5하':'tier5_low','짐승':'tier5_low','짐승상':'tier5_high','짐승하':'tier5_low','5상':'tier5_high','5하':'tier5_low','5티어상':'tier5_high','5티어하':'tier5_low','5티어 상':'tier5_high','5티어 하':'tier5_low'};return map[c]||raw;}
  function lane(role){return {tier0_high:'0상',tier0_mid:'0중',tier0_low:'0하',tier1_high:'1상',tier1_mid:'1중',tier1_low:'1하',tier2_high:'2상',tier2_mid:'2중',tier2_low:'2하',tier3_high:'3상',tier3_mid:'3중',tier3_low:'3하',tier4_high:'4상',tier4_mid:'4중',tier4_low:'4하',beast:'5하',beast_high:'5상',beast_low:'5하',tier5_high:'5상',tier5_low:'5하'}[role]||role;}
  function defaults(){return {'0상':{target:85,death:-3},'0중':{target:75,death:-3},'0하':{target:65,death:-3},'1상':{target:55,death:-3},'1중':{target:50,death:-3},'1하':{target:45,death:-3},'2상':{target:40,death:-3},'2중':{target:35,death:-2},'2하':{target:30,death:-2},'3상':{target:25,death:-2},'3중':{target:20,death:-2},'3하':{target:15,death:-1},'4상':{target:10,death:-1},'4중':{target:5,death:-1},'4하':{target:0,death:-1},'5하':{target:-5,death:-1},'5상':{target:0,death:-1},'짐승':{target:-5,death:-1}};}
  ...
  function loadTierScoreConfig(){return fetch('/api/pkl-shared?key='+encodeURIComponent('pklTierScoreConfig'),{cache:'no-store',headers:{Accept:'application/json'}}).then(function(r){return r.json().catch(function(){return {};});}).then(function(data){window.__PKL_TIER_SCORE_CONFIG=(data&&data.item&&data.item.value&&typeof data.item.value==='object')?data.item.value:{};try{renderSnapshot(buildSnapshot());}catch(e){};}).catch(function(e){console.error('PKL scoreboard tier score config load failed',e);});}
